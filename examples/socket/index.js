const config = new quantsdk.Configuration({
  isTestnet: true,
  baseURL: "https://otc.network:7734/api/v1", websocketURL: "ws://otc.network:7755/ws/"
})
const sdk = new quantsdk.QuantSDK(config)
var model = null
